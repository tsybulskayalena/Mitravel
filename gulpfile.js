...
function libs() {
  src(source_folder + "/assets/videos/*.*").pipe(dest(project_folder + "/assets/videos/"));
  src(source_folder + "/PHPMailer/*").pipe(dest(project_folder + "/PHPMailer/"));
  src([
